A memory game in which you must find several pair/even cards with several thmes choice.
...
Compile the sources how to:
Download the sources of this release unzip it in a directory of your choice, then in the main directory run cmake with for example (on linux):
'cmake -G"Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -S./ -B../build
Then go to the build directory made by the '-B' argument with cd ../build and run 'make all'
